	...
	<?php foreach($pelanggan as $p) : ?>
		<form action="<?php echo base_url().'pelanggan/update_pelanggan/'; ?>" method="post">
			...
			<div class="form-group">
				...
				<input type="text" name="nama_pelanggan" value="<?php echo $p -> no_telepon; ?>" class="form-control">
			</div>
			<div class="form-group">
				<label for="nama_pelanggan">Alamat</label>
				<input type="text" name="nama_pelanggan" value="<?php echo $p -> alamat; ?>" class="form-control">
			</div>
			<div class="form-group">
